...
class Pridavanie_objektov:
    tuknute_body = []#pre usecky, priamky a kruznice
...
# TODO vsetko uz je to hrozne chillova robota - to si nechaj na zufalsie casy
# da sa vytiahnut body mimo pola - to by sa mohlo dat opravit nejak spravitelne dufam, ze ak je pri okraji tak nebude fungovat dragovanie danym smerom
# mali by sa rozsvietit nazlto ked sa tuknu tie body
# os usecky, os uhla, stred dvoch bodov, kolmica, rovnobezka, opisana kruznica, dotycnica, osova symetria (nezaujimave) - to chce fungovat podla mna tak, ze si spravim tu konstrukciu, ale nezobrazim to
# skusit si narysovat nejake konstrukcie - urcite tam budu nejake chyby - tie potom opravit  toto sa fakto oplati spravit skor, nez to bude komplikovanejsie
# zabezpecit aby som nedal rovnake body pre priamky, kruznice a veci kde to nema zmysel

# blbosticky
# napisat niekde ze tukni na dva body ked stlacis nejake tlacitko
# blika to ked posuvam bod rychlo
# pridavanie bodov rozumnejsie - ze tuknem a tam sa prida asi

#ui vysvetlenia
#ked pridavame polpriamku, treba najprv tuknut ten zaciatkovy bod a a z potom ten druhy.


#funkcne:
# ak ma priesecnik vyjst blizko existujuceho bodu, nech sa tam nenakresli - toto znie rozumne - mozno jedine co potrebujem je to, ze ked sa nejake body prekryvaju - tak navrchu bude ten co bol vytvoreny skor v poradi instrukcii
#       toto je problem len ak v cervenom bode bude nejaky priesecnik, inak sa proste nakresli vela modrych na seba a to neni moc problem.